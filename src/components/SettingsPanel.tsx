      ...
      <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-3xl shadow-2xl p-8 w-full max-w-md mx-4 transform transition-all`}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-r from-orange-400 to-orange-600 p-3 rounded-2xl">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            >
              ...
              <div className={`w-12 h-6 rounded-full transition-colors ${showBetaFeatures ? 'bg-orange-600' : 'bg-gray-400'} relative`}>
        ...
        <div className={`mt-8 pt-6 border-t ${darkMode ? 'border-gray-600' : 'border-gray-200'}`}>
          <button
            onClick={onClose}
            className="w-full bg-gradient-to-r from-orange-400 to-orange-600 text-white py-4 px-6 rounded-2xl hover:from-orange-500 hover:to-orange-700 transition-all transform hover:scale-105 font-bold text-lg shadow-lg"
          >
